...
const falas = [
  ...
  { 
    textos: [ "O verão envolve Neverwinter em um calor confortáve",
              "Conhecida como a  Joia do Norte, Neverwinter já sofreu tragédias que quase a destruíram",
              "Mas hoje, sob o comando firme do Lorde Dagult Neverember",
              "A cidade ressurge lentamente, seus bairros sendo reconstruídos sobre as cicatrizes do passado.",
    ],
  ...
  { 
    textos: [ "O barco está prestes a atracar no porto",
              "O barco atraca.. e",
              "Você desce entre marinheiros, comerciantes e viajantes que correm pelas docas.",
              "No bolso, sente o peso da carta recebida ainda em sua terra natal.",
    ],
    imagens: ["imagens/Porto-neverwinter.png", "imagens/Porto-neverwinter.png"],
    musica: "Medieval rua porto.mp3"
  },
